...
async function init() {
    ...
    try {
        ...
        user = await User.create({
            ...
            email: "fharozkhan143@gmail.com",  // If we don't pass this, it will throw the error
            userType: "ADMIN",
            password :bcrypt.hashSync("faroz123", 8) //this field should be hidden from the end user
